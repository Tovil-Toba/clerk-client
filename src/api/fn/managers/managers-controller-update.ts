...
export function managersControllerUpdate(http: HttpClient, rootUrl: string, params: ManagersControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<Manager>> {
